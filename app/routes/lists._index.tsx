...
import { Plus, List, Users, Trash2, Edit, Eye, Upload, Download } from 'lucide-react'
                        ...
                        <div className="flex space-x-2">
                          ...
                          <Form method="post" className="inline">
                            ...
                            <Button
                              ...
                              disabled={isSubmitting}
                              onClick={(e) => {
                                if (!confirm(`Are you sure you want to delete "${list.name}"? This will remove all members from the list.`)) {
                                  e.preventDefault()
                                }
                              }}
                            >
